...
def isolate_runtime_state():
    ...
    import symbio.rag as _rag
    real_notes = constants.NOTES_DIR
    real_notes_archive = constants.NOTES_ARCHIVE_DIR
    real_rag_notes = _rag.NOTES_DIR
    real_mistakes = constants.MISTAKES_DIR
    real_mistakes_archive = constants.MISTAKES_ARCHIVE_DIR
    ...
    try:
        ...
        constants.MISTAKES_DIR = real_mistakes
        constants.MISTAKES_ARCHIVE_DIR = real_mistakes_archive
